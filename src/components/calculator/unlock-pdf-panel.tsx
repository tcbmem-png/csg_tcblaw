    ...
    return (
      ...
      >
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Use the <strong>Print / Save PDF</strong> button on the worksheet
          above to save a filing-ready copy.
        </p>
      </div>
    );
  }
  ...
  if (status === "sent") {
    return (
      ...
      >
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Your worksheet was emailed to <strong>{sentTo}</strong>. You can also
          use the <strong>Print / Save PDF</strong> button on the worksheet
          above.
        </p>
      </div>
